...
class _ChatPageState extends State<ChatPage> {
  ...
  Future<void> _onMessageFocusChange() async {
    final hasFocus = _messageFocusNode.hasFocus;
    if (_hasMessageFocus != hasFocus) {
      ...
      appBar: AppBar(
        ...
        title: Obx(() {
          ...
          if (type == 'group' && title != null && title.isNotEmpty) {
            return Text('Group chat', style: TextsStyles.titleMedium);
          }
          if (type == 'direct' && title != null && title.isNotEmpty) {
            return Text('Chat with $title', style: TextsStyles.titleMedium);
          }
          return Text('Chat', style: TextsStyles.titleMedium);
        }),
      ),
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              _hasMessageFocus ? SizedBox.shrink() : SizedBox(height: 16.h),
