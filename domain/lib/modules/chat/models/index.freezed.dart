...
@override
String toString() {
  return 'ChatEntity(chatId: $chatId, type: $type, participants: $participants, groupName: $groupName, groupAvatar: $groupAvatar, lastMessage: $lastMessage, lastMessageTime: $lastMessageTime, createdBy: $createdBy)';
}
...
class _ChatEntity implements ChatEntity {
  const _ChatEntity({required this.chatId, required this.type, required final  List<String> participants, this.groupName, this.groupAvatar, this.lastMessage, this.lastMessageTime, this.createdBy}): _participants = participants;
