...
class _AuthApiService implements AuthApiService {
  ...
  @override
  Future<AuthTokensApiDto> refresh(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(body);
    final _options = _setStreamType<AuthTokensApiDto>(
    ...
    late AuthTokensApiDto _value;
    try {
      _value = AuthTokensApiDto.fromJson(_result.data!);
    } on Object catch (e, s) {
