...
part of 'homework_api_service.dart';
...
class _HomeworkApiService implements HomeworkApiService {
  _HomeworkApiService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<HomeworkApiDto> addHomework({
    ...
    late HomeworkApiDto _value;
    try {
      _value = HomeworkApiDto.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<List<HomeworkApiDto>> getHomeworks(String groupId) async {
    ...
    final _options = _setStreamType<List<HomeworkApiDto>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/Homework/group/${groupId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    late List<HomeworkApiDto> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) => HomeworkApiDto.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
  ...
  Future<HomeworkApiDto> reopenHomework(String homeworkId) async {
    ...
    final _options = _setStreamType<HomeworkApiDto>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/Homework/${homeworkId}/reopen',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
